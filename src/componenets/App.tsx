...
const App: React.FC = () => {
  ...
  const menuHandler = (): void => setMenu(!menuOn);
	...
	return (
      ...
      {menuOn && <MobileMenu menuOn={menuOn} menuHandler={menuHandler} signInHandler={signInHandler}/>}
				{signIn && (
					<SignInModal
						signIn={signIn}
				...
				{isDesktop ? <DesktopComponent signInHandler={signInHandler}/> : <MobileComponent menuHandler={menuHandler} />}
			</div>
		</div>
	);
};
